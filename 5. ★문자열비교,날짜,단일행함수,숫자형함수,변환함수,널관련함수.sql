...
----------------------------------------------------------------
SELECT 
    RPAD('Steve', 10, '-'), -- 오른쪽에 주어진 문자를 채움 Steve-----
    LPAD('Steve', 10, '*'),  -- 왼쪽에 주어진 문자를 채움 *****Steve
    REPLACE('Java Programmer Java', 'Java', 'BigData') AS "REPLACE" -- 문자를 변경   ( 파라미터 3개면 변경) BigData Programmer BigData
    , REPLACE('Java Programmer', 'Java') AS "REPLACE" -- 문자를 제거 (파라미터 2개면 제거)  Programmer
FROM dual;
----------------------------------------------------------------
SELECT
